...
extern "C" {
#endif
void  hs_0_M_0_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_11__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_11__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__output_simv_daidir (UB  * pcode, vec32  * I1006, U  I915);
void  hs_0_M_3_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_4_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_5_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_0__output_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_11__output_simv_daidir (UB  * pcode, scalar  val);
